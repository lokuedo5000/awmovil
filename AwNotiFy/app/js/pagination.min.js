      ...
      l = {
        ...
        generateHTML: function(a) {
          ...
          if (I && (c = e.replaceVariables(I, {
            ...
            if (A += '<div class="paginationjs-pages">', A += z ? '<ul class="' + z + '">' : "<ul>", l && (f <= 1 ? G || (A += '<li class="' + w + "-prev " + y + '"><a>' + '<span><i class="notext">b</i> <i class="icons cwI-chevron-left"></i></span>' + "</a></li>") : A += '<li class="' + w + '-prev J-paginationjs-previous" data-num="' + (f - 1) + '"><a href="' + r + '">' + '<span><i class="notext">b</i> <i class="icons cwI-chevron-left"></i></span>' + "</a></li>"), n) {
              if (h <= 3)
            ...
            m && (f >= g ? H || (A += '<li class="' + w + "-next " + y + '"><a>' + '<span><i class="notext">n</i> <i class="icons cwI-chevron-right"></i></span>' + "</a></li>") : A += '<li class="' + w + '-next J-paginationjs-next" data-num="' + (f + 1) + '"><a href="' + r + '">' + '<span><i class="notext">n</i> <i class="icons cwI-chevron-right"></i></span>' + "</a></li>"), A += "</ul></div>"
          }
